...
<div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php foreach ($br->result() as $cetak){ ?>
            <?php $set = $cetak->ID_BERITA ;?>
            <form class="form-horizontal" action="<?= base_url('spv/edit_news')?>" 
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    ...
                    <input type="text" class="form-control" placeholder="judul"value="<?=$cetak->JUDUL_BERITA ?>" name="judul">
                  </div>
                </div>
              <div class="form-group">
               ...
               <div class="col-sm-8">
                    ...
                    <textarea id="editor1"name="isi" rows="10" cols="80" > <?=$cetak->ISI_BERITA ?>
                ...
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Gambar</label>
                    <img src="<?= base_url()?>asset/berita/<?= $cetak->FOTO_BERITA ?>" height="142" width="142">
                    <input type="hidden" name="gambarasli" value="<?= $cetak->FOTO_BERITA ?>" />
