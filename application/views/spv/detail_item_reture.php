    ...
    <section class="content-header">
      <h1>
       DETAIL PRODUCT DELIVERY
        <small>detail RETURE Barang</small>
      </h1>
      <ol class="breadcrumb">
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
               <div class="col-xs-12">
          <h3 style="text-align: center;">RETURE</h3>
<h4 style="text-align: center; "><i class="form-group "></i>RETURE</h4>
<hr />
<br />
<div class="row">
   <div class="col-md-2">
   ...
   <div class="col-md-2">
      <b>:<?php echo $deliv->KODE_RETURE; ?></b>
   </div>
   </div>
   <div class="row">
   <div class="col-md-2">
