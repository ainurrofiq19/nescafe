    ...
    <div class="row">
      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <form class="form-horizontal" action="<?= base_url('Bp/add_code_reture')?>"
              ...
              <?php foreach($cetak1 as $data1){?>
                <tr>
                  ...
                  <td>
                   ...
                   <?php
                    if ($data1->STATUS == 2 ) { ?>
                     <a href="<?= base_url("Bp/detail_item_reture/$data1->KODE_RETURE")?>" class="btn btn-success">Detail</a>
                      <a  class="btn btn-default">Be Accepted</a>
                <?php    }else{ ?>
                      <a href="<?= base_url("Bp/detail_item_reture/$data1->KODE_RETURE")?>" class="btn btn-success">Detail</a>
                      <a href="<?= base_url("Bp/update_item_reture/$data1->KODE_RETURE")?>" class="btn btn-primary">Update</a>
                  <?php  }
                  ?>
                </td>
                </tr>
