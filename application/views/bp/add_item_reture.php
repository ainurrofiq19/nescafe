...
<div class="col-md-4">
          ...
          <div class="box box-info">
            <form class="form-horizontal" action="<?= base_url('Bp/add_item_reture/'.$code)?>"
            ...
            <!-- form start -->
              ...
              <div class="box-footer">
                <a href="<?php echo base_url(); ?>Bp/cancel_item_reture/<?=$code?>" class="btn btn-primary">Cancel</a>
      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          <?php if ($tanda == $data1->ID_RETURE) { ?>
              ...
              <tr>
                <form class="form-horizontal" action="<?= base_url('Bp/edit_item_reture')?>" method="post">
                ...
                <td>
                  ...
                  <a href="<?= base_url("Bp/hapus_item_reture/$data1->KODE_RETURE/$code")?>" class="btn btn-danger small">Hapus</a>
          ...
          <?php  }else { ?>
            <tr>
              ...
              <td><a href="<?= base_url("Bp/update_item_reture2/$code/$data1->ID_RETURE")?>" class="btn btn-primary small">Edit</a>
                  <a href="<?= base_url("Bp/hapus_item_reture2/$data1->KODE_RETURE/$code")?>" class="btn btn-danger small">Hapus</a></td>
            </tr>
          <?php } ?>
        <?php } ?>
        </tbody>
